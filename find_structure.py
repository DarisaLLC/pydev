...
class structure_detection(object):
    """
    VP Detection Object
    ...
    def __init__(self,
        ...
        self.__angle_tol = np.pi / 2  # (pi / 180 * (60 degrees)) --> +/- 45 deg
    ...
    def find_vps(self, img):
        ...
        shape = img.shape
        if self._down_sample > 1:
            img = cv2.resize(img, (shape[1]//self._down_sample, shape[0]//self._down_sample))
...
def main(input_path):
    ...
    # Create object
    vpd = structure_detection(length_thresh, principal_point, focal_length, 1, seed)
