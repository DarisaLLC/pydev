...
'''
Takes name as label for the point
'''
class PointContainer(list):
    def __new__(self, value, name = None):
...
if __name__ == '__main__':
    ...
    points = [PointContainer(rand_point(dim), name=x) for x in range(10000)]
    additional_points = [PointContainer(rand_point(dim),name=x+10001) for x in range(50)]
