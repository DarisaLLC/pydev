...
class movement_direction:
    ...
    def draw_tracks(self, frame, points1, points2):
        ...
        if not (self.avg_angle is None):
            ...
            cv.putText(frame, direction, (self.width//2, self.height//2), cv.FONT_HERSHEY_DUPLEX,
                        2, (225, 0, 0), 7)

        cv.putText(frame, str(self.frame_count), (self.width // 16, (15*self.height) // 16), cv.FONT_HERSHEY_SIMPLEX,
                   1, (0, 255, 0), 2)
        return frame
