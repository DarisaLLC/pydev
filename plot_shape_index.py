...
image = io.imread('/Volumes/t5backup/polybiomics/256by256.png', as_gray = True)
image = ndi.gaussian_filter(image, sigma=3.0)
...
s_smooth = ndi.gaussian_filter(s, sigma=1.0)
